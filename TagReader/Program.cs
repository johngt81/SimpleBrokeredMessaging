...
namespace TagReader
{
    class Program
    {
        private static string ConnectionString = "Endpoint=sb://bg-servicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=H5BpZJ8uCl7VdXZxpCm4WH/gCqDtSDWhwyane+ZWPeQ=";
